...
public class TokenService {
    ...
    public String gerarToken(Usuario usuario) {
        try {
            ...
            throw new RegraNegocioException("Erro interno ao gerar o token de acesso.");
        }
    }
    ...
    public String getSubject(String tokenJWT) {
        try {
            ...
            throw new RegraNegocioException("Token JWT inválido ou expirado. Faça login novamente.");
        }
    }
